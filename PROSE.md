...
- **Keep it to the decision and one reason.** Two or three sentences closes most threads. How long you spent investigating has nothing to do with how long the reply should be — a week of benchmarking still closes in three sentences. If the comment reads like a summary of your work, cut it.
...
- **Use the phrase a normal English speaker would use.** Bending a set phrase onto something it does not take reads as broken, not terse. "Worth carrying to #6319" is not English — you carry a change forward into a later PR; you do not carry a note to one. Rewrite the sentence plainly instead of adjusting the words around it.
- **Don't cut the words that say what you are talking about.** Shortening is fine until the sentence loses its subject or object. "Fine for construction, not for leaf parses" — fine for construction of what? "A shared one can't work" — a shared what? Read the shortened draft as someone with no context; if you cannot tell what *it*, *one* or *this* means, put the noun back.
