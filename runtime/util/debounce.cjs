...
// Port of https://github.com/nodejs/node/blob/a2c8da59f2e319860985ff1275d66a6d16d611b0/lib/internal/util/debounce.js
const { AbortError, addAbortListener, ArrayPrototypePush, kEmptyObject, markPromiseAsHandled, ObjectDefineProperties, PromiseReject, PromiseWithResolvers, ReflectApply, TIMEOUT_MAX, validateAbortSignal, validateBoolean, validateFunction, validateInteger, validateObject } = require("./internals.cjs");
