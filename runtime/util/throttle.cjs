...
// Port of https://github.com/nodejs/node/blob/a2c8da59f2e319860985ff1275d66a6d16d611b0/lib/internal/util/throttle.js
const { AbortError, ERR_THROTTLED, addAbortListener, ArrayPrototypePush, ArrayPrototypeSlice, kEmptyObject, markPromiseAsHandled, ObjectDefineProperties, PromisePrototypeThen, PromiseReject, PromiseResolve, PromiseWithResolvers, ReflectApply, TIMEOUT_MAX, timersBinding, validateAbortSignal, validateBoolean, validateFunction, validateInteger, validateObject, validateOneOf } = require("./internals.cjs");
