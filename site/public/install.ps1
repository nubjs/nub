...
# Usage: irm https://raw.githubusercontent.com/colinhacks/nub/main/install.ps1 | iex
...
if ($Version -eq "latest") {
    $Release = Invoke-RestMethod "https://api.github.com/repos/colinhacks/nub/releases/latest"
...
$Url = "https://github.com/colinhacks/nub/releases/download/v$Version/nub-$Target.zip"
