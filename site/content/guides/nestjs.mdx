...
// tsconfig.json
{
  "compilerOptions": {
    // ...
    "experimentalDecorators": true,  // the form Nest is written against
    "emitDecoratorMetadata": true    // design:paramtypes for the DI
  }
}
```
...
{
  "compilerOptions": {
    "plugins": ["@nestjs/swagger"]   // only under nest build / start
  }
}
```
