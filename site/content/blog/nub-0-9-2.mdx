---
title: "Nub 0.9.2"
description: Gives the standalone runner a nubr command that runs a TypeScript file, a package.json script, or an installed bin.
author: The Nub Team
date: 2026-09-13
---

Nub 0.9.2 adds `nubr` to the standalone runner, `@nubjs/runner`. It runs a TypeScript file, a `package.json` script, or an installed bin on plain Node, with no Nub binary anywhere.
