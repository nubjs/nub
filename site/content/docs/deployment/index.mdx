...
In a pnpm project, copy `pnpm-lock.yaml` instead of `nub.lock`. A project with an npm, Yarn, or Bun lockfile [migrates it](/docs/install/migrate) first.
...
<Callout>
Read the [full docs](https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-container-registry) on docs.github.com.
</Callout>
