...
The Render CLI can create the same repository-backed Docker service:
...
curl --fail https://nub-app.onrender.com/alive
...
The Render CLI can create the same service without the dashboard:
