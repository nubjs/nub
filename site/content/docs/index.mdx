...
Nub also ships its own tap, bumped during the release run rather than by a separate pull request, so it reaches a new version first: `brew install nubjs/tap/nub`.
