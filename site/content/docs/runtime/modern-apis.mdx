...
Node crashes on `import.defer(specifier)`, the dynamic counterpart of this syntax. The defect is upstream and reproduces on plain Node, so prefer the static form.
</Callout>
