...
|---|---|
| 22.23.2 | 512 MiB–2 GiB |
| 24.20.0 | 512 MiB |
| 26.8.1 | 512 MiB–1 GiB |

Tuning stops once each release's own nursery reaches 16 MiB. Node 24.20.0 reaches that size immediately above 512 MiB, so it needs no override at larger budgets. Limits below 512 MiB are excluded because a larger nursery increased OOM kills in smaller-container pressure tests. Other releases and platforms keep Node's defaults.
