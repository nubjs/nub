...
The conditions apply to every resolution in the project, so the bare-specifier [preload](/docs/runtime#project-configuration) above loads `./register.dev.js` rather than the default.
