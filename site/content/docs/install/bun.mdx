...
Not read: `[install].linker`. A Bun-owned project selects the layout through the neutral `.npmrc` key or the CLI flag. See [resolution versus layout](/docs/install#resolution-versus-layout).
