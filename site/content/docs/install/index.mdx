...
Choose dependency updates
  dependencies
❯   @effect/opentelemetry  ■ keep 4.0.0-beta.90  □ range 4.0.0-beta.100
    chalk                  ■ keep 4.1.0          □ range 4.1.2           □ latest 5.6.2
    react                  ■ keep 17.0.1         □ range 17.0.2          □ latest 19.2.8
  devDependencies
    typescript             ■ keep 5.3.2          □ range 5.3.3           □ latest 7.0.2
