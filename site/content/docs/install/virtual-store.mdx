...
The hoisting keys, modules directory, and virtual-store paths work the same way — see [layout](/docs/install#layout) for the full field list. The `nub.jsonc` layout fields apply whoever owns the project.
