...
Augmented modes require **Node 18.19+** (Node 18 LTS). On Node 22.15 and newer Nub registers its hooks synchronously with `module.registerHooks()`; on 18.19–22.14 it falls back to the async `module.register()` loader. Below 18.19, augmented commands emit a tagged error telling you to upgrade.
