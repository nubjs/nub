...
Yes. A nightly build of `main` publishes a full 8-platform build under the rolling [canary release](https://github.com/nubjs/nub/releases/tag/canary). Nights when `main` gained no code change are skipped. Install it with the install script:
