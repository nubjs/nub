...
Canary is the bleeding edge: it may break, and each build replaces the last. Homebrew, winget, and mise carry only stable releases, so upgrading through them always lands on a release.
