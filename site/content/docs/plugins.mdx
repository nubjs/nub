...
- [Bin runner](/docs/nubx) — `nubx`, for running a tool by name without installing it as a subcommand.
- [Script runner](/docs/run) — `nub run`, which shares the bin-resolution chain.
