...
Three fields take paths: [`preload`](#preload), [`envFile`](#envfile), and [`tsconfig`](#tsconfig). A relative path resolves against the directory of the file that set it — not your working directory.
