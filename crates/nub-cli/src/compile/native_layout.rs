...
fn architecture_advice() -> &'static str {
    "  Install a compatible optional package before compiling. For cross-platform installs,\n  configure supportedArchitectures.os, supportedArchitectures.cpu, and\n  supportedArchitectures.libc so the target's native packages are present."
}
