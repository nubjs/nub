...
Per-flag augmentation verdicts — does the loader break — live in [`node-flag-interactions.md` §3 / §4.6 / §4.7](node-flag-interactions.md). Here: how Nub-as-node orders and forwards them around its injected `--import`.
