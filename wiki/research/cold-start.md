...
[cl8349534]: https://chromium-review.googlesource.com/c/v8/v8/+/8349534
[v8670fcec]: https://chromium.googlesource.com/v8/v8/+/670fcec55cc81367590dd352a1a95ac806b62f73
...
- 2026-09-10 — The entropy change landed in Node `main` as [#65796][pr65796] (commit `43d3fe9558`), after its Worker test was rewritten to park eight Workers without a crypto call: below OpenSSL 3, `ncrypto::CSPRNG` retries forever when the per-thread DRBG cannot come out of the secure heap, so the earlier form of the test hung on the shared-OpenSSL-1.1.1 build. The `mul_mod` change is under review in V8 as [CL 8349534][cl8349534], where Node's V8 policy places it.
- 2026-09-18 — The `mul_mod` change landed in V8 `main` as [commit `670fcec55c`][v8670fcec], the second of the two fixes measured here to reach an upstream tree. Node carries it when it next rolls V8.
