...
<small>Last updated: {{ new Date(data.updated).toISOString().slice(0, 10) }} · Source: [`benchmarks/results.json`](https://github.com/aubepkg/aube/blob/main/benchmarks/results.json), regenerated by `mise run bench:bump`.</small>
