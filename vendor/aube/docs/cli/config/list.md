...
## Flags
- **`--all`** — Also list settings that have no value set.
...
- **`--json`** — Emit all entries as a JSON object keyed by setting name.
...
- **`--location <LOCATION>`** — Which config location(s) to list.
